...
src/tools/tool-bot-01/

Tests:

tests/tools/tool-bot-01/

Documentation:

docs/tools/implementation/tool-bot-01/
...
Fleet IDs may be generated wherever the Tool is invoked; authority remains outside TOOL-BOT-01.
...
Fleet creation, ownership, persistence, and authority remain outside TOOL-BOT-01.
...
TOOL-BOT-01 does not implement a separate online/offline generation mode.
