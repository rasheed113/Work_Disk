...
struct A:Authority{bool allow=true;bool may_deliver(const NotificationCommand&)const override{return allow;}};
struct P:Provider{NotificationResult deliver(const NotificationCommand&)const override{return {ResultCode::Accepted,"delivery"};}};
