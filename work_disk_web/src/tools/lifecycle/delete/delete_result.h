...
public:
    ...
    static DeleteResult alreadyDeleted(
        std::string requestId
    );
    ...
    static DeleteResult invalidRequest(
        std::string requestId
    );

    static DeleteResult missingAuthority(
        std::string requestId
    );

    static DeleteResult invalidTarget(
        std::string requestId
    );


    static DeleteResult persistenceFailure(
        std::string requestId
    );

    static DeleteResult transactionFailure(
        std::string requestId
    );

    static DeleteResult boundaryFailure(
        std::string requestId
    );
